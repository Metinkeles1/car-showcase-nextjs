...
Welcome to the Car Showcase Website! This project, built with Next.js, introduces you to an immersive platform to explore a diverse range of cars effortlessly. Leveraging Next.js' server-side rendering, we ensure fast loading times and smooth transitions.
...
```bash
git clone https://github.com/Metinkeles1/car-showcase-nextjs.git
